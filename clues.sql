...
SELECT name, region, code, population
FROM countries
...
SELECT countrycode, isofficial, language
...
SELECT countrycode, language, isofficial, percentage from countrylanguages where language = 'Italian' and isofficial = True;
SELECT name, region, code from countries where code = 'SMR';
